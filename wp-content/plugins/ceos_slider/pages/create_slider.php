					...
					<div class="set-row">
						...
						<div class="set-row inner">
							<span id="prop-width-wrap">
								...
								<input type="number" id="opt-max-width" name="opt-max-width" min="0" step="1" value="<?= ($editObj->getMaxWidth() ? $editObj->getMaxWidth() : 1920) ?>">
								<label>px</label>
							</span>
							<span id="prop-height-wrap">
								<label class="main" for="opt-max-height"><?= __('Height') ?></label>
								<input type="number" id="opt-max-height" name="opt-max-height" min="0" step="1" value="<?= ($editObj->getMaxHeight() ? $editObj->getMaxHeight() : 640) ?>">
								<label>px</label>
							</span>
						</div>
						<div class="set-row inner">
